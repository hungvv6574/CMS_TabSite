...
namespace CMSSolutions.Websites.Extensions
{
    public static class ScriptRegisterExtensions
    {
        ...
        public static void IncludeBootstrap(this ScriptRegister register)
        {
            ...
            register.Include("bootstrap/jquery.bootpag.js");
        }
        ...
        {
            register.Include("jssorslider/jssor.slider.min.js").AtFoot();
        }

        public static void IncludeFlexSlider(this ScriptRegister register)
        {
            register.Include("flexslider/jquery.flexslider.js").AtFoot();
        }
        ...
        public static void IncludeThemesDefaults(this ScriptRegister register)
        {
            ...
            register.Include("themesdefaults/jquery.highlight-5.js").AtFoot();
        }
    }
}